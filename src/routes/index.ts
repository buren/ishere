...
app.doc('/openapi.json', {
	...
	info: {
		title: 'IsHere API',
		version: '1.0.0',
		// TODO write a better description with an overview of the API
		description: `## Overview

- 🚀 **Blazing Fast**: Leverages Cloudflare KV's global network (+330 cities, +125 countries).
- 🛤️ **Customizable Paths:** Define namespaces and custom paths for short links (e.g., \`/washere/ee2A2\`, \`/washere/my-campaign-link\`).
