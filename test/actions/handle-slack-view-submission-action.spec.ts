...
const makeCreatePayload = (destinationUrl: string, namespace: string | null = null, shortPath: string | null = null) => ({
	type: 'view_submission' as const,
	view: {
		callback_id: 'create_link',
		state: {
			values: {
				destination_url_block: { destination_url: { type: 'url_text_input', value: destinationUrl } },
				namespace_block: { namespace: { type: 'plain_text_input', value: namespace } },
				short_path_block: { short_path: { type: 'plain_text_input', value: shortPath } },
			},
		},
	},
});
